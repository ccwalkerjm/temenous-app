...
<template>
  <div v-bind:class="onsenClasses.formSection" v-bind:data-test="auth.signUp.section">
    <div
      v-bind:class="onsenClasses.sectionHeader"
      v-bind:data-test="auth.signUp.headerSection"
    >{{this.options.header}}</div>
    <div v-bind:class="onsenClasses.sectionBody" v-bind:data-test="auth.signUp.bodySection">
      <div
        ...
        <div v-bind:class="onsenClasses.fieldFormat">
          <div v-if="signUpField.key !== 'phone_number'">
            ...
            <input
              ...
              v-bind:class="[onsenClasses.input, signUpField.invalid ? 'invalid': '']"
    ...
    <div v-bind:class="onsenClasses.sectionFooter" v-bind:data-test="auth.signUp.footerSection">
  ...
  methods: {
    setOptions() {
      ...
      if (
        ...
        */
        this.signUpConfig.signUpFields.slice().sort((a, b) => {
      ...
      this.$Amplify.Auth.signUp(user)
        .then(data => {
          ...
          if (data.userConfirmed === false) {
            return AmplifyEventBus.$emit("authState", "confirmSignUp",false);
          }         
          return AmplifyEventBus.$emit("authState", "signIn",false);
        })
