...
<template>
  <div v-bind:class="onsenClasses.formSection" v-bind:data-test="auth.confirmSignIn.section">
    <div
      v-bind:class="onsenClasses.sectionHeader"
      v-bind:data-test="auth.confirmSignIn.headerSection"
    >{{options.header}}</div>
    <div v-bind:class="onsenClasses.sectionBody" v-bind:data-test="auth.confirmSignIn.bodySection">
